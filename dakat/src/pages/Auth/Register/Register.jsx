...
const Register = () => {
  ...
  const [registerMethod, setRegisterMethod] = useState('gmail') // 'gmail' or 'password'
  ...
  const handleGoogleSignUp = async (e) => {
    ...
    if (!userType || !agreeTerms) {
      setError('Please select your role and agree to terms')
      return
    }
    ...
    try {
      ...
      console.log('User registered:', data.user.displayName)
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-black to-gray-900 flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-gray-800 rounded-xl shadow-2xl p-8 border border-gray-700">
        <h1 className="text-3xl font-bold text-white mb-2 text-center">Join Us</h1>
        <p className="text-gray-400 text-center mb-8">Start your journey today</p>
        ...
        <form onSubmit={registerMethod === 'gmail' ? handleGoogleSignUp : handleEmailPasswordSignUp} className="space-y-4">
          ...
          <div className="flex gap-2 mb-4 border-b border-gray-700">
            <button
              type="button"
              onClick={() => setRegisterMethod('gmail')}
          ...
          {registerMethod === 'gmail' && (
            <button
              type="submit"
              disabled={isLoading || !userType || !agreeTerms}
          ...
          <div className="text-center text-sm text-gray-400">
            ...
            <Link to="/auth/login" className="text-[#00ff41] hover:underline ml-1">
              Sign In
            </Link>
          </div>
        </form>
